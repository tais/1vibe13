...
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_PLAYERS_LOST_MERCS = 85;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_FIRST_MERC_DIES = 86;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_BIFF_IS_DEAD = 87;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_HAYWIRE_IS_DEAD = 88;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_GASKET_IS_DEAD = 89;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_RAZOR_IS_DEAD = 90;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_FLO_IS_DEAD_BIFF_ALIVE = 91;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_FLO_IS_DEAD_BIFF_IS_DEAD = 92;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_GUMPY_IS_DEAD = 93;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_LARRY_IS_DEAD = 94;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_COUGER_IS_DEAD = 95;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_NUMB_IS_DEAD = 96;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_BUBBA_IS_DEAD = 97;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_GASTON_DEAD = 98;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_STOGIE_DEAD = 99;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_LARRY_RELAPSED = 100;
inline constexpr UINT16 JA2_SPECK_QUOTE_SPECK_UNAVAILABLE = 87;
inline constexpr UINT16 JA2_SPECK_PLAYABLE_QUOTE_FLO_MARRIED = 101;
...
static_assert(JA2_SPECK_PLAYABLE_QUOTE_PLAYERS_LOST_MERCS == SPECK_PLAYABLE_QUOTE_PLAYERS_LOST_MERCS);
static_assert(JA2_SPECK_PLAYABLE_QUOTE_FIRST_MERC_DIES == SPECK_PLAYABLE_QUOTE_FIRST_MERC_DIES);
static_assert(JA2_SPECK_PLAYABLE_QUOTE_BIFF_IS_DEAD == SPECK_PLAYABLE_QUOTE_BIFF_IS_DEAD);
static_assert(JA2_SPECK_PLAYABLE_QUOTE_STOGIE_DEAD == SPECK_PLAYABLE_QUOTE_STOGIE_DEAD);
static_assert(JA2_SPECK_PLAYABLE_QUOTE_LARRY_RELAPSED == SPECK_PLAYABLE_QUOTE_LARRY_RELAPSED);
static_assert(JA2_SPECK_QUOTE_SPECK_UNAVAILABLE == SPECK_QUOTE_SPECK_UNAVAILABLE);
static_assert(JA2_SPECK_PLAYABLE_QUOTE_FLO_MARRIED == SPECK_PLAYABLE_QUOTE_FLO_MARRIED_A_COUSIN_BIFF_IS_ALIVE);
#endif
