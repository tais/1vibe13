...
inline constexpr INT32 JA25_EMAIL_AIM_MEDICAL_DEPOSIT_REFUND = 27;
inline constexpr INT32 JA25_EMAIL_AIM_MEDICAL_DEPOSIT_REFUND_LENGTH = 3;
inline constexpr INT32 JA25_EMAIL_AIM_MEDICAL_DEPOSIT_PARTIAL_REFUND = 214;
inline constexpr INT32 JA25_EMAIL_AIM_MEDICAL_DEPOSIT_PARTIAL_REFUND_LENGTH = 3;
inline constexpr INT32 JA25_EMAIL_AIM_MEDICAL_DEPOSIT_NO_REFUND = 217;
inline constexpr INT32 JA25_EMAIL_AIM_MEDICAL_DEPOSIT_NO_REFUND_LENGTH = 3;

// Arulco campaign offsets are also campaign data, not properties of the
// executable. Qualified constants let runtime-selected code retain the exact
// existing Email.edt layout even when another campaign is the host default.
inline constexpr INT32 JA2_EMAIL_MERC_INTRO = 19;
inline constexpr INT32 JA2_EMAIL_MERC_INTRO_LENGTH = 5;
inline constexpr INT32 JA2_EMAIL_MERC_NEW_SITE_ADDRESS = 24;
inline constexpr INT32 JA2_EMAIL_MERC_NEW_SITE_ADDRESS_LENGTH = 2;
inline constexpr INT32 JA2_EMAIL_MERC_WARNING = 30;
inline constexpr INT32 JA2_EMAIL_MERC_WARNING_LENGTH = 2;
inline constexpr INT32 JA2_EMAIL_MERC_INVALID = 32;
inline constexpr INT32 JA2_EMAIL_MERC_INVALID_LENGTH = 2;
inline constexpr INT32 JA2_EMAIL_MERC_FIRST_WARNING = 36;
inline constexpr INT32 JA2_EMAIL_MERC_FIRST_WARNING_LENGTH = 2;
inline constexpr INT32 JA2_EMAIL_AIM_MEDICAL_DEPOSIT_REFUND = 26;
inline constexpr INT32 JA2_EMAIL_AIM_MEDICAL_DEPOSIT_REFUND_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_AIM_MEDICAL_DEPOSIT_PARTIAL_REFUND = 214;
inline constexpr INT32 JA2_EMAIL_AIM_MEDICAL_DEPOSIT_PARTIAL_REFUND_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_AIM_MEDICAL_DEPOSIT_NO_REFUND = 217;
inline constexpr INT32 JA2_EMAIL_AIM_MEDICAL_DEPOSIT_NO_REFUND_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_IMP_AGAIN = 13;
inline constexpr INT32 JA2_EMAIL_IMP_AGAIN_LENGTH = 6;
inline constexpr INT32 JA2_EMAIL_IMP_INTRO = 0;
inline constexpr INT32 JA2_EMAIL_IMP_INTRO_LENGTH = 10;
inline constexpr INT32 JA2_EMAIL_ENRICO_CONGRATS = 10;
inline constexpr INT32 JA2_EMAIL_ENRICO_CONGRATS_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_IMP_PROFILE_RESULTS = 29;
inline constexpr INT32 JA2_EMAIL_IMP_PROFILE_RESULTS_LENGTH = 1;
inline constexpr INT32 JA2_EMAIL_AIM_REPLY_BARRY = 58;
inline constexpr INT32 JA2_EMAIL_AIM_REPLY_BARRY_LENGTH = 2;
inline constexpr INT32 JA2_EMAIL_ENRICO_MIGUEL = 149;
inline constexpr INT32 JA2_EMAIL_ENRICO_MIGUEL_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_ENRICO_PROGRESS_20 = 152;
inline constexpr INT32 JA2_EMAIL_ENRICO_PROGRESS_20_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_ENRICO_PROGRESS_55 = 155;
inline constexpr INT32 JA2_EMAIL_ENRICO_PROGRESS_55_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_ENRICO_PROGRESS_80 = 158;
inline constexpr INT32 JA2_EMAIL_ENRICO_PROGRESS_80_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_ENRICO_SETBACK = 161;
inline constexpr INT32 JA2_EMAIL_ENRICO_SETBACK_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_ENRICO_SETBACK_2 = 164;
inline constexpr INT32 JA2_EMAIL_ENRICO_SETBACK_2_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_ENRICO_CREATURES = 167;
inline constexpr INT32 JA2_EMAIL_ENRICO_CREATURES_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_ENRICO_LACK_PROGRESS_1 = 189;
inline constexpr INT32 JA2_EMAIL_ENRICO_LACK_PROGRESS_1_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_ENRICO_LACK_PROGRESS_2 = 192;
inline constexpr INT32 JA2_EMAIL_ENRICO_LACK_PROGRESS_2_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_ENRICO_LACK_PROGRESS_3 = 195;
inline constexpr INT32 JA2_EMAIL_ENRICO_LACK_PROGRESS_3_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_BOBBYR_NOW_OPEN = 182;
inline constexpr INT32 JA2_EMAIL_BOBBYR_NOW_OPEN_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_INSURANCE_PAYMENT = 170;
inline constexpr INT32 JA2_EMAIL_INSURANCE_PAYMENT_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_INSURANCE_SUSPICIOUS = 173;
inline constexpr INT32 JA2_EMAIL_INSURANCE_SUSPICIOUS_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_INSURANCE_INVESTIGATION_OVER = 176;
inline constexpr INT32 JA2_EMAIL_INSURANCE_INVESTIGATION_OVER_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_INSURANCE_SUSPICIOUS_REPEAT = 179;
inline constexpr INT32 JA2_EMAIL_INSURANCE_SUSPICIOUS_REPEAT_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_BOBBYR_SHIPMENT_ARRIVED = 198;
inline constexpr INT32 JA2_EMAIL_BOBBYR_SHIPMENT_ARRIVED_LENGTH = 4;
inline constexpr INT32 JA2_EMAIL_JOHN_KULBA_GIFT = 202;
inline constexpr INT32 JA2_EMAIL_JOHN_KULBA_GIFT_LENGTH = 4;
inline constexpr INT32 JA2_EMAIL_MERC_DIED_OTHER_ASSIGNMENT = 206;
inline constexpr INT32 JA2_EMAIL_MERC_DIED_OTHER_ASSIGNMENT_LENGTH = 5;
inline constexpr INT32 JA2_EMAIL_INSURANCE_ONE_HOUR_FRAUD = 211;
inline constexpr INT32 JA2_EMAIL_INSURANCE_ONE_HOUR_FRAUD_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_INSURANCE_POLICY_VIOLATION = 267;
inline constexpr INT32 JA2_EMAIL_INSURANCE_POLICY_VIOLATION_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_JOHN_KULBA_MISSED_FLIGHT_1 = 224;
inline constexpr INT32 JA2_EMAIL_JOHN_KULBA_MISSED_FLIGHT_1_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_JOHN_KULBA_MISSED_FLIGHT_2 = 227;
inline constexpr INT32 JA2_EMAIL_JOHN_KULBA_MISSED_FLIGHT_2_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_JOHN_KULBA_MISSED_FLIGHT_3 = 230;
inline constexpr INT32 JA2_EMAIL_JOHN_KULBA_MISSED_FLIGHT_3_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_PMC_INTRO = 233;
inline constexpr INT32 JA2_EMAIL_PMC_INTRO_LENGTH = 3;
inline constexpr INT32 JA2_EMAIL_KINGPIN_BOUNTY_INITIAL = 236;
inline constexpr INT32 JA2_EMAIL_KINGPIN_BOUNTY_INITIAL_LENGTH = 6;
inline constexpr INT32 JA2_EMAIL_KINGPIN_BOUNTY_REWARD = 242;
inline constexpr INT32 JA2_EMAIL_KINGPIN_BOUNTY_REWARD_LENGTH = 4;
inline constexpr INT32 JA2_EMAIL_KINGPIN_BOUNTY_ANGEL_THANKS = 246;
inline constexpr INT32 JA2_EMAIL_KINGPIN_BOUNTY_ANGEL_THANKS_LENGTH = 4;
inline constexpr INT32 JA2_EMAIL_KINGPIN_BOUNTY_TARGET_FOUND = 250;
inline constexpr INT32 JA2_EMAIL_KINGPIN_BOUNTY_TARGET_FOUND_LENGTH = 4;
inline constexpr INT32 JA2_EMAIL_KINGPIN_BOUNTY_TARGET_ESCAPED = 254;
inline constexpr INT32 JA2_EMAIL_KINGPIN_BOUNTY_TARGET_ESCAPED_LENGTH = 4;
inline constexpr INT32 JA2_EMAIL_MILITIA_ROSTER_INTRO = 258;
inline constexpr INT32 JA2_EMAIL_MILITIA_ROSTER_INTRO_LENGTH = 4;
inline constexpr INT32 JA2_EMAIL_INTEL_INTRO = 262;
inline constexpr INT32 JA2_EMAIL_INTEL_INTRO_LENGTH = 5;
inline constexpr INT32 JA25_EMAIL_CONGRATS = 44;
inline constexpr INT32 JA25_EMAIL_CONGRATS_LENGTH = 4;
inline constexpr INT32 JA25_EMAIL_CONGRATS_MIGUEL_SICK = 48;
inline constexpr INT32 JA25_EMAIL_CONGRATS_MIGUEL_SICK_LENGTH = 5;
inline constexpr INT32 JA25_EMAIL_CONGRATS_MIGUEL_SICK_MANUEL_DEAD = 53;
inline constexpr INT32 JA25_EMAIL_CONGRATS_MIGUEL_SICK_MANUEL_DEAD_LENGTH = 6;
inline constexpr INT32 JA25_EMAIL_CONGRATS_MIGUEL_SICK_MANUEL_ALIVE = 59;
inline constexpr INT32 JA25_EMAIL_CONGRATS_MIGUEL_SICK_MANUEL_ALIVE_LENGTH = 6;
inline constexpr INT32 JA25_EMAIL_CONGRATS_MANUEL_DEAD = 65;
...
inline constexpr INT32 JA25_EMAIL_PILOT_MISSING = 8;
inline constexpr INT32 JA25_EMAIL_PILOT_MISSING_LENGTH = 2;
inline constexpr INT32 JA25_EMAIL_MAKE_CONTACT = 10;
inline constexpr INT32 JA25_EMAIL_MAKE_CONTACT_LENGTH = 3;
inline constexpr INT32 JA25_EMAIL_MANUEL = 13;
inline constexpr INT32 JA25_EMAIL_MANUEL_LENGTH = 4;
inline constexpr INT32 JA25_EMAIL_MIGUEL_HELLO = 17;
inline constexpr INT32 JA25_EMAIL_MIGUEL_HELLO_LENGTH = 3;
inline constexpr INT32 JA25_EMAIL_IMP_AGAIN = 93;
inline constexpr INT32 JA25_EMAIL_IMP_AGAIN_LENGTH = 5;
inline constexpr INT32 JA25_EMAIL_IMP_INTRO = 83;
inline constexpr INT32 JA25_EMAIL_IMP_INTRO_LENGTH = 10;
inline constexpr INT32 JA25_EMAIL_IMP_PROFILE_RESULTS = 198;
inline constexpr INT32 JA25_EMAIL_IMP_PROFILE_RESULTS_LENGTH = 1;
inline constexpr INT32 JA25_EMAIL_AIM_REPLY_BARRY = 98;
inline constexpr INT32 JA25_EMAIL_AIM_REPLY_BARRY_LENGTH = 2;
inline constexpr INT32 JA25_EMAIL_AIM_PROMOTION_1 = 184;
inline constexpr INT32 JA25_EMAIL_AIM_PROMOTION_1_LENGTH = 4;
inline constexpr INT32 JA25_EMAIL_MERC_PROMOTION_1 = 188;
inline constexpr INT32 JA25_EMAIL_MERC_PROMOTION_1_LENGTH = 5;
inline constexpr INT32 JA25_EMAIL_AIM_PROMOTION_2 = 193;
inline constexpr INT32 JA25_EMAIL_AIM_PROMOTION_2_LENGTH = 5;
...
//---ja25 ub
	...
	static_assert(JA25_EMAIL_CONGRATS == EMAIL_CONGRATS);
	static_assert(JA25_EMAIL_CONGRATS_LENGTH == EMAIL_CONGRATS_LENGTH);
	static_assert(JA25_EMAIL_CONGRATS_MIGUEL_SICK == EMAIL_CONGRATSICK);
	static_assert(JA25_EMAIL_CONGRATS_MIGUEL_SICK_LENGTH == EMAIL_CONGRATSICK_LENGTH);
	static_assert(JA25_EMAIL_CONGRATS_MIGUEL_SICK_MANUEL_DEAD == EMAIL_CONGRATMIGMANUELDEAD);
	static_assert(JA25_EMAIL_CONGRATS_MIGUEL_SICK_MANUEL_DEAD_LENGTH == EMAIL_CONGRATMIGMANUELDEAD_LENGTH);
	static_assert(JA25_EMAIL_CONGRATS_MIGUEL_SICK_MANUEL_ALIVE == EMAIL_CONGRATMIGMANUELALIVE);
	static_assert(JA25_EMAIL_CONGRATS_MIGUEL_SICK_MANUEL_ALIVE_LENGTH == EMAIL_CONGRATMIGMANUELALIVE_LENGTH);
	static_assert(JA25_EMAIL_CONGRATS_MANUEL_DEAD == EMAIL_CONGRATMANUELDEAD);
	...
	static_assert(JA25_EMAIL_PILOT_MISSING == EMAIL_PILOTMISSING);
	static_assert(JA25_EMAIL_PILOT_MISSING_LENGTH == EMAIL_PILOTMISSING_LENGTH);
	static_assert(JA25_EMAIL_MAKE_CONTACT == EMAIL_MAKECONTACT);
	static_assert(JA25_EMAIL_MAKE_CONTACT_LENGTH == EMAIL_MAKECONTACT_LENGTH);
	static_assert(JA25_EMAIL_MANUEL == EMAIL_MANUEL);
	static_assert(JA25_EMAIL_MANUEL_LENGTH == EMAIL_MANUEL_LENGTH);
	static_assert(JA25_EMAIL_MIGUEL_HELLO == EMAIL_MIGUELHELLO);
	static_assert(JA25_EMAIL_MIGUEL_HELLO_LENGTH == EMAIL_MIGUELHELLO_LENGTH);
	...
	static_assert(JA25_EMAIL_IMP_AGAIN == IMP_EMAIL_AGAIN);
	static_assert(JA25_EMAIL_IMP_AGAIN_LENGTH == IMP_EMAIL_AGAIN_LENGTH);
	static_assert(JA25_EMAIL_AIM_REPLY_BARRY == AIM_REPLY_BARRY);
	static_assert(JA25_EMAIL_AIM_REPLY_BARRY_LENGTH == AIM_REPLY_LENGTH_BARRY);
	...
	static_assert(JA25_EMAIL_AIM_PROMOTION_1 == EMAIL_AIM_PROMOTION_1);
	static_assert(JA25_EMAIL_AIM_PROMOTION_1_LENGTH == EMAIL_AIM_PROMOTION_1_LENGTH);
	static_assert(JA25_EMAIL_MERC_PROMOTION_1 == EMAIL_MERC_PROMOTION_1);
	static_assert(JA25_EMAIL_MERC_PROMOTION_1_LENGTH == EMAIL_MERC_PROMOTION_1_LENGTH);
	static_assert(JA25_EMAIL_AIM_PROMOTION_2 == EMAIL_AIM_PROMOTION_2);
	static_assert(JA25_EMAIL_AIM_PROMOTION_2_LENGTH == EMAIL_AIM_PROMOTION_2_LENGTH);
	...
	static_assert(JA2_EMAIL_ENRICO_CONGRATS == ENRICO_CONGRATS);
	static_assert(JA2_EMAIL_ENRICO_CONGRATS_LENGTH == ENRICO_CONGRATS_LENGTH);
	...
	static_assert(JA2_EMAIL_IMP_AGAIN == IMP_EMAIL_AGAIN);
	static_assert(JA2_EMAIL_IMP_AGAIN_LENGTH == IMP_EMAIL_AGAIN_LENGTH);
	static_assert(JA2_EMAIL_AIM_REPLY_BARRY == AIM_REPLY_BARRY);
	static_assert(JA2_EMAIL_AIM_REPLY_BARRY_LENGTH == AIM_REPLY_LENGTH_BARRY);
	#define AIM_REPLY_MELTDOWN		(AIM_REPLY_BARRY + ( 39 * AIM_REPLY_LENGTH_BARRY ))
	#define AIM_REPLY_LENGTH_MELTDOWN		AIM_REPLY_LENGTH_BARRY
	...
	static_assert(JA2_EMAIL_ENRICO_MIGUEL == ENRICO_MIGUEL);
	static_assert(JA2_EMAIL_ENRICO_MIGUEL_LENGTH == ENRICO_MIGUEL_LENGTH);
...
#ifndef JA2UB
static_assert(JA2_EMAIL_MERC_INTRO == MERC_INTRO);
static_assert(JA2_EMAIL_MERC_INTRO_LENGTH == MERC_INTRO_LENGTH);
static_assert(JA2_EMAIL_MERC_NEW_SITE_ADDRESS == MERC_NEW_SITE_ADDRESS);
static_assert(JA2_EMAIL_MERC_NEW_SITE_ADDRESS_LENGTH == MERC_NEW_SITE_ADDRESS_LENGTH);
static_assert(JA2_EMAIL_MERC_WARNING == MERC_WARNING);
static_assert(JA2_EMAIL_MERC_WARNING_LENGTH == MERC_WARNING_LENGTH);
static_assert(JA2_EMAIL_MERC_INVALID == MERC_INVALID);
static_assert(JA2_EMAIL_MERC_INVALID_LENGTH == MERC_INVALID_LENGTH);
static_assert(JA2_EMAIL_MERC_FIRST_WARNING == MERC_FIRST_WARNING);
static_assert(JA2_EMAIL_MERC_FIRST_WARNING_LENGTH == MERC_FIRST_WARNING_LENGTH);
...
static_assert(JA2_EMAIL_AIM_MEDICAL_DEPOSIT_REFUND == AIM_MEDICAL_DEPOSIT_REFUND);
static_assert(JA2_EMAIL_AIM_MEDICAL_DEPOSIT_REFUND_LENGTH == AIM_MEDICAL_DEPOSIT_REFUND_LENGTH);
static_assert(JA2_EMAIL_AIM_MEDICAL_DEPOSIT_PARTIAL_REFUND == AIM_MEDICAL_DEPOSIT_PARTIAL_REFUND);
static_assert(JA2_EMAIL_AIM_MEDICAL_DEPOSIT_PARTIAL_REFUND_LENGTH == AIM_MEDICAL_DEPOSIT_PARTIAL_REFUND_LENGTH);
static_assert(JA2_EMAIL_AIM_MEDICAL_DEPOSIT_NO_REFUND == AIM_MEDICAL_DEPOSIT_NO_REFUND);
static_assert(JA2_EMAIL_AIM_MEDICAL_DEPOSIT_NO_REFUND_LENGTH == AIM_MEDICAL_DEPOSIT_NO_REFUND_LENGTH);
static_assert(JA2_EMAIL_BOBBYR_NOW_OPEN == BOBBYR_NOW_OPEN);
static_assert(JA2_EMAIL_BOBBYR_NOW_OPEN_LENGTH == BOBBYR_NOW_OPEN_LENGTH);
static_assert(JA2_EMAIL_JOHN_KULBA_MISSED_FLIGHT_1 == JOHN_KULBA_MISSED_FLIGHT_1);
static_assert(JA2_EMAIL_JOHN_KULBA_MISSED_FLIGHT_1_LENGTH == JOHN_KULBA_MISSED_FLIGHT_1_LENGTH);
static_assert(JA2_EMAIL_JOHN_KULBA_MISSED_FLIGHT_2 == JOHN_KULBA_MISSED_FLIGHT_2);
static_assert(JA2_EMAIL_JOHN_KULBA_MISSED_FLIGHT_2_LENGTH == JOHN_KULBA_MISSED_FLIGHT_2_LENGTH);
static_assert(JA2_EMAIL_JOHN_KULBA_MISSED_FLIGHT_3 == JOHN_KULBA_MISSED_FLIGHT_3);
static_assert(JA2_EMAIL_JOHN_KULBA_MISSED_FLIGHT_3_LENGTH == JOHN_KULBA_MISSED_FLIGHT_3_LENGTH);
static_assert(JA2_EMAIL_PMC_INTRO == PMC_INTRO);
static_assert(JA2_EMAIL_PMC_INTRO_LENGTH == PMC_INTRO_LENGTH);
static_assert(JA2_EMAIL_KINGPIN_BOUNTY_INITIAL == KINGPIN_BOUNTY_INITIAL);
static_assert(JA2_EMAIL_KINGPIN_BOUNTY_INITIAL_LENGTH == KINGPIN_BOUNTY_INITIAL_LENGTH);
static_assert(JA2_EMAIL_KINGPIN_BOUNTY_REWARD == KINGPIN_BOUNTY_KINGPIN_REWARD);
static_assert(JA2_EMAIL_KINGPIN_BOUNTY_REWARD_LENGTH == KINGPIN_BOUNTY_KINGPIN_REWARD_LENGTH);
static_assert(JA2_EMAIL_KINGPIN_BOUNTY_ANGEL_THANKS == KINGPIN_BOUNTY_ANGEL_THANKS);
static_assert(JA2_EMAIL_KINGPIN_BOUNTY_ANGEL_THANKS_LENGTH == KINGPIN_BOUNTY_ANGEL_THANKS_LENGTH);
static_assert(JA2_EMAIL_KINGPIN_BOUNTY_TARGET_FOUND == KINGPIN_BOUNTY_BH_GOTTARGET);
static_assert(JA2_EMAIL_KINGPIN_BOUNTY_TARGET_FOUND_LENGTH == KINGPIN_BOUNTY_BH_GOTTARGET_LENGTH);
static_assert(JA2_EMAIL_KINGPIN_BOUNTY_TARGET_ESCAPED == KINGPIN_BOUNTY_TARGET_GOTAWAY);
static_assert(JA2_EMAIL_KINGPIN_BOUNTY_TARGET_ESCAPED_LENGTH == KINGPIN_BOUNTY_TARGET_GOTAWAY_LENGTH);
static_assert(JA2_EMAIL_MILITIA_ROSTER_INTRO == MILITIAROSTER_INTRO);
static_assert(JA2_EMAIL_MILITIA_ROSTER_INTRO_LENGTH == MILITIAROSTER_INTRO_LENGTH);
static_assert(JA2_EMAIL_INTEL_INTRO == INTEL_ENRICO_INTRO);
static_assert(JA2_EMAIL_INTEL_INTRO_LENGTH == INTEL_ENRICO_INTRO_LENGTH);
#endif
