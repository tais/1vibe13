...
inline constexpr std::uint16_t SimulationCommandJournalWireVersion = 6;
...
// transport. Encoding always produces version 6 and requires resolved actor
// identities. Decoding also accepts versions 1 through 5; a version-1 slot-only
...
// version 6. Variant indexes are never serialized.
//
