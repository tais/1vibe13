...
namespace
{
bool IsValidMaskSource(HVOBJECT source, UINT16 frame)
{
	return source &&
		source->ubBitDepth == 8 &&
...
BOOLEAN Zero8BPPDataTo16BPPBufferTransparentClip(
	PIXEL* pBuffer,
...
{
	if (!pBuffer || !IsValidMaskSource(hSrcVObject, usIndex))
		return FALSE;
...
BOOLEAN Zero8BPPDataTo16BPPBufferTransparent(
	PIXEL* pBuffer,
	UINT32 uiDestPitchBYTES,
	HVOBJECT hSrcVObject,
	INT32 iX,
