...
void HandleTacticalFunctionSelection( TacticalActor *pSoldier, INT32 sGridNo );	// Flugente: in tactical, open a selection box for different actions

void HandleSoldierUseCorpse( TacticalActor *pSoldier, INT32 sGridNo, INT8 bLevel );	// Flugente: handle corpses
void HandleSoldierDefuseTripwire( TacticalActor *pSoldier, INT32 sGridNo, INT32 sItem );	// Flugente: defuse tripwire
...
void BeginMineSpottedDialogue( TacticalActor *pSoldier, INT32 sGridNo );
...
BOOLEAN IsStructureConstructItem( UINT16 usItem, INT32 sGridNo, TacticalActor* pSoldier );	// can we construct a structure with this item?
BOOLEAN IsStructureDeconstructItem( UINT16 usItem, INT32 sGridNo, TacticalActor* pSoldier );	// can we remove a structure with this item?
BOOLEAN BuildFortification( INT32 sGridNo, TacticalActor *pSoldier, OBJECTTYPE *pObj );		// build a structure, return true if sucessful
BOOLEAN RemoveFortification( INT32 sGridNo, TacticalActor *pSoldier, OBJECTTYPE *pObj );		// remove a structure, return true if sucessful
