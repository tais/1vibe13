...
// Campaign data uses different bit ranges for the same endgame dialogue
// concepts. Keep both layouts explicit so runtime campaign selection never
// depends on a host preprocessor definition.
inline constexpr UINT32 JA2_MULTIPURPOSE_EVENT_DONE_KILLING_DEIDRANNA = 0x00000001;
inline constexpr UINT32 JA2_MULTIPURPOSE_EVENT_TEAM_MEMBERS_DONE_TALKING = 0x00000002;
inline constexpr UINT32 JA25_MULTIPURPOSE_EVENT_GETUP_AFTER_HELI_CRASH = 0x08000000;
inline constexpr UINT32 JA25_MULTIPURPOSE_EVENT_DONE_KILLING_DEIDRANNA = 0x10000000;
inline constexpr UINT32 JA25_MULTIPURPOSE_EVENT_TEAM_MEMBERS_DONE_TALKING = 0x20000000;
static_assert(
