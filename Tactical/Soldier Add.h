...
INT32 FindGridNoFromSweetSpotWithStructDataFromSoldier( TacticalActor *pSoldier, UINT16 usAnimState, INT8 ubRadius, UINT8 *pubDirection, BOOLEAN fClosestToMerc, TacticalActor *pSrcSoldier, BOOLEAN fAllowSoldierCurrentGrid = FALSE );
